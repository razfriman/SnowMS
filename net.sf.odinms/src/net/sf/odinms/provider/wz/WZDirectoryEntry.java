...
public class WZDirectoryEntry extends WZEntry implements MapleDataDirectoryEntry {
	...
	public WZDirectoryEntry(String name, int size, int checksum, int offset, MapleDataEntity parent) {
	...
	public MapleDataDirectoryEntry getDirectoryEntry(String name) {
	    for(MapleDataDirectoryEntry subDirectory : subdirs) {
