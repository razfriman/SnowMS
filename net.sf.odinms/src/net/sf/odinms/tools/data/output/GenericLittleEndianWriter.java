...
public class GenericLittleEndianWriter implements LittleEndianWriter {
	...
	/**
	 * Writes a ASCII string prefixed with it's length as an [int] to the steam
	 * 
	 * @param s The ASCII string to write.
	 */
	@Override
	public void writeIntPrefixedAsciiString(String s) {
	    writeInt(s.length());
	    writeAsciiString(s);
	}
	...
	@Override
	public void writePoint(Point pos) {
	writeShort(pos.x);
	writeShort(pos.y);   
	}
	
	@Override
	public void writeNullData(int len) {
	    write(new byte[len]);
	}
