...
public class DueyActionHandler extends AbstractMaplePacketHandler {
	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		MapleDueyAction type = MapleDueyAction.getById(actionByte);
		switch(type) {
			case SEND_ITEM:
			{
				MapleInventory inv = c.getPlayer().getInventory(MapleInventoryType.getByType(slea.readByte()));
