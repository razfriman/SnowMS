...
public class MobTurncoatHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        slea.readByte();// Same as player damage, -1 = bump, integer = skill ID
        int damage = slea.readInt();
        slea.readByte();//direction
        slea.readPoint();//Damage display position
