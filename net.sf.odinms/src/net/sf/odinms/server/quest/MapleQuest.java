...
public class MapleQuest {
	...
	protected int order;
	protected List<String> statusText = new ArrayList<String>();
	...
	private static MapleDataProvider questData = MapleDataProviderFactory.getWzFile("Quest.wz");
	...
	private MapleQuest(int id) {
		...
		name = MapleDataTool.getString("name", questInfo, "NONAME");
		parent = MapleDataTool.getString("parent", questInfo, "NONAME");
		area = MapleDataTool.getInt("area", questInfo, 0);
		order = MapleDataTool.getInt("order", questInfo, 0);
		areaName = MapleDataTool.getString(MapleDataProviderFactory.getWzFile("Etc.wz").getData("QuestCategory.img").getChildByPath(Integer.toString(area)));
		for(MapleData textInfo : questInfo.getIntegerNamedChildren()) {
			statusText.add(MapleDataTool.getString(textInfo));
		}
