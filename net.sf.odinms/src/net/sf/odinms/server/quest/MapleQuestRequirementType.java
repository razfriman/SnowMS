...
public enum MapleQuestRequirementType {
	...
	public static MapleQuestRequirementType getByWZName(String name) {
		...
		else if (name.equals("endmeso")) return END_MESO;
		else if (name.equals("pettamenessmin")) return MIN_PET_TAMENESS;
		else if (name.equals("mbmin")) return MONSTER_BOOK;
		else if (name.equals("startscript")) return START_SCRIPT;
		else if (name.equals("endscript")) return END_SCRIPT;
		//equipAllNeed noramlAutoStart petRecallLimit petAutoSpeakingLimit
