...
public class TimerManager implements TimerManagerMBean {
	...
	public ScheduledFuture<?> register(Runnable r, long repeatTime, boolean startNow) {
		return ses.scheduleAtFixedRate(new LoggingSaveRunnable(r), startNow ? 0 : repeatTime, repeatTime, TimeUnit.MILLISECONDS);
	}
