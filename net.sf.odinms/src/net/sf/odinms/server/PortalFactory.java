...
public class PortalFactory {
	...
	public MaplePortal makePortal(int type, MapleData portal, int mapid) {
		...
		loadPortal(ret, portal, mapid);
		return ret;
	}
	
	private void loadPortal(MapleGenericPortal myPortal, MapleData portal, int mapid) {
		myPortal.setMapId(mapid);
		...
		myPortal.setOnlyOnce(MapleDataTool.getInt(portal.getChildByPath("onlyOnce"), 0) > 0);
