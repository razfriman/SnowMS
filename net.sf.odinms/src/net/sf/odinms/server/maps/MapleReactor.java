...
public class MapleReactor extends AbstractMapleMapObject {
	...
	public void reset() {
		setState((byte) 0);
		getMap().broadcastMessage(MaplePacketCreator.triggerReactor(this, 0));
	}
	...
	public void swapStats(MapleReactor reactor) {
		MapleReactorStats temp = reactor.getStats();
		reactor.setStats(stats);
		setStats(temp);
	}
	...
	public void update() {
		map.broadcastMessage(MaplePacketCreator.triggerReactor(this, state));
	}
