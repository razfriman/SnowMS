...
public class MapleReactorFactory {
	...
	private static MapleDataProvider data = MapleDataProviderFactory.getWzFile("Reactor.wz");
	...
	public static MapleReactorStats getReactor(int rid) {
		...
		if (stats == null) {
			...
			if (stats == null) {
                ...
                if (reactorData.getChildByPath("action") != null) {
                    stats.setAction(MapleDataTool.getString("action", reactorData));
                }
