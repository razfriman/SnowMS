...
import net.sf.odinms.client.MapleCharacterObject;
import net.sf.odinms.client.MapleCharacterObjectType;
 ...
 * @author Matze
 */
public class MapleStorage implements MapleCharacterObject {
	private int id;
    ...
    public MapleCharacterObjectType getType() {
        return MapleCharacterObjectType.STORAGE;
    }
	...
	public void sendStorage(MapleClient c, int npcId) {
		arrangeItemsByInv();// sort by inventorytype to avoid confusion
