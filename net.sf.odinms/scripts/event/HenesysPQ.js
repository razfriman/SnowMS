...
function setup() {
	...
	finishMap = em.getChannelServer().getMapFactory().getMap(910010100);
	var instanceName = "HenesysPQ" + instanceId;
	var eim = em.newInstance(instanceName);	
	instanceId++;
    
	var map0 = eim.getMapInstance(910010000);//PQ-MapX
	eim.getMapInstance(910010100);//FinishX
	eim.getMapInstance(910010200);//BonusX
	eim.getMapInstance(910010300);//Back To Town
	//eim.getMapInstance(910010400);//Exit
    
    map0.setSpawnEnabled(false);
    map0.killAllMonsters(null, false);
...
function playerEntry(eim, player) {
	var map0 = eim.getMapInstance(910010000);
