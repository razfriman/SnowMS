...
function start() {
	cm.sendNext("Do you wanna head over to some other town? With a little money involved, I can make it happen. It's a tad expensive, but I run a special 90% discount for beginners.");
        var selection1 = cm.sendSimple("It's understandable that you may be confused about this place if this is your first time around. If you got any questions about this place, fire away.\r\n#L0##bWhat kind of towns are here in Victoria Island?#l\r\n#L1#Please take me somewhere else.#k#l");
        if (selection1 == 0) {
            var selection2 = cm.sendSimple("There are 6 big towns here in Victoria Island. Which of those do you want to know more of?\r\n#L0##bLith Harbor#l\r\n#L1#Perion#l\r\n#L2#Ellinia#l\r\n#L3#Henesys#l\r\n#L4#Kerning City#l\r\n#L5#Sleepywood#k#l");
        }
        //TODO REST
}
