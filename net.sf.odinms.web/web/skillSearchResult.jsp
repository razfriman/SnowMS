...
<%@page import="net.sf.odinms.web.SkillSearch"%>
...
<br /><br />
	...
	if (session.getAttribute("skillSearch") == null)
		return;
	SkillSearch search = (SkillSearch) session.getAttribute("skillSearch");
	...
	%>
		<tr>
			...
			<td>
				<a href="skill.jsp?skill=<%= skill.getId() %>"><%= skillName %></a>
			</td>
			<td>
			<img src="IconExtractor?skill=<%= skill.getId() %>" alt=<%= skillName %> />
			</td>
		</tr>
