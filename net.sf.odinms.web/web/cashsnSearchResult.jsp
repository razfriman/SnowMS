...
<%@page import="net.sf.odinms.web.CashSNSearch"%>
...
<br /><br />
			...
			<div id="main">
	<%
	if (session.getAttribute("cashsnSearch") == null)
		return;
	CashSNSearch search = (CashSNSearch) session.getAttribute("cashsnSearch");
	...
	<%
	for (int snId : toShow) {
                CashItemInfo CItem = CashItemFactory.getItem(snId);
	%>
		<tr>
			<td>
				<%= CItem.getId() %>
