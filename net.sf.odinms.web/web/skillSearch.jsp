...
<html xmlns="http://www.w3.org/1999/xhtml" version="-//W3C//DTD XHTML 1.1//EN" xml:lang="en">
	<head>
		<title>Skill Search - WebWiz</title>
...
<br /><br />
			...
			<div id="main">
        <h2 class="ad" border="0">Search Skill</h2>
	<fieldset class="box">
	<form method="post" action="skill.jsp">
	<input type="text" name="skill"/><input type="submit" value="Jump to ID"/>
	</form>
	</fieldset>
	<fieldset class="box">
...
<input type="hidden" name="action" value="search"/>
		...
		<label for="job">Job</label><input id="job" type="text" name="job"/><br/>
