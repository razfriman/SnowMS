...
<html xmlns="http://www.w3.org/1999/xhtml" version="-//W3C//DTD XHTML 1.1//EN" xml:lang="en">
	<head>
		<title>Item Search - WebWiz</title>
...
<br /><br />
			...
			<div id="main">
        <h2 class="ad" border="0">Search Item</h2>
	<fieldset class="box">
	<form method="post" action="item.jsp">
	<input type="text" name="item"/><input type="submit" value="Jump to ID"/>
	</form>
	</fieldset>
	...
	<form method="post" action="ItemServlet">
		...
		<label for="text">Name/Desc</label><input id="text" type="text" name="text"/><br/>
		<label for="type">Type</label>
		<select id="type" name="type">
		<%
		for (MapleInventoryType type : MapleInventoryType.values()) {
			%>
			<option value="<%= type.getType() %>"><%= type %></option>
			<%
		}
		%>
		</select>
