...
<html xmlns="http://www.w3.org/1999/xhtml" version="-//W3C//DTD XHTML 1.1//EN" xml:lang="en">
	<head>
		<title>CashShopSN Search - WebWiz</title>
...
<br /><br />
			...
			<div id="main">
        <h2 class="ad" border="0">Search CashShop-SN</h2>
	<fieldset class="box">
	<form method="post" action="cashshopsn.jsp">
	<input type="text" name="sn"/><input type="submit" value="Use SN-ID"/>
	</form>
	</fieldset>
	<fieldset class="box">
	<form method="post" action="cashshopsn.jsp">
	<input type="text" name="item"/><input type="submit" value="Use Item-ID"/>
	</form>
	</fieldset>

	<fieldset class="box">
	<form method="post" action="cashshopsn.jsp">
	<input type="text" name="hex"/><input type="submit" value="Use Hex-String"/>
	</form>
	</fieldset>

	<fieldset class="box">
	<form method="post" action="cashshopsn.jsp">
	<input type="text" name="hexrev"/><input type="submit" value="Use Hex-String(REVERSE)"/>
	</form>
	</fieldset>
