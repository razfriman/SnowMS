...
<%@page import="net.sf.odinms.web.MapSearch"%>
...
<br /><br />
	...
	if (session.getAttribute("mapSearch") == null)
		return;
	MapSearch search = (MapSearch) session.getAttribute("mapSearch");
	...
	%>
		<tr>
			...
			<td>
				<a href="map.jsp?map=<%= mapId %>"><%= map.getMapName() %></a>
			</td>
		</tr>
	<%
	}
