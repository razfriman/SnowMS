...
<br /><br />
			...
			<div id="main">
        <h2 class="ad" border="0">Search Job</h2>
	<fieldset class="box">
	<form method="post" action="job.jsp">
	<input type="text" name="job"/><input type="submit" value="Jump to ID"/>
	</form>
	</fieldset>
	<fieldset class="box">
