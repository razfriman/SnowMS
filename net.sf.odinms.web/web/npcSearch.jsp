...
<br /><br />
			...
			<div id="main">
        <h2 class="ad" border="0">Search NPC</h2>
	<fieldset class="box">
	<form method="post" action="npc.jsp">
	<input type="text" name="npc"/><input type="submit" value="Jump to ID"/>
	</form>
	</fieldset>
	<fieldset class="box">
	<form method="post" action="NPCServlet">
